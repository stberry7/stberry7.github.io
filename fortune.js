          ...
          if (year >= 1900 && year <= 2020) {
            ...
            if (month >= 1 && month <= 12 && day >= 1 && day <= 31) {
              ...
              if (selectedOption === '오늘 운세') {
                fileName = 'fortune/1_today001.html';
              } else if (selectedOption === '내일 운세') {
                fileName = 'fortune/1_tomorrow001.html';
              } else if (selectedOption === '이번주 운세') {
                fileName = 'fortune/1_week001.html';
              } else if (selectedOption === '이번달 운세') {
                fileName = 'fortune/1_month001.html';
              } else if (selectedOption === '올해 운세') {
                fileName = 'fortune/1_year001.html';
              }

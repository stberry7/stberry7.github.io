        ...
        if (year >= 1900 && year <= 2020) {
          ...
          if (month >= 1 && month <= 12 && day >= 1 && day <= 31) {
            ...
            if (selectedOption === '오늘 운세') {
              ...
              fileName = `fortune/1_today${randomIndex.toString().padStart(3, '0')}.html`;
            } else if (selectedOption === '내일 운세') {
              fileName = 'fortune/2_tomorrow001.html';
            } else if (selectedOption === '이번주 운세') {
              fileName = 'fortune/3_week001.html';
            } else if (selectedOption === '이번달 운세') {
              fileName = 'fortune/4_month001.html';
            } else if (selectedOption === '올해 운세') {
              fileName = 'fortune/5_year001.html';
            }
